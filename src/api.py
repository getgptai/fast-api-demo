...
async def startup_event():
    ...
    - Initializes the database tables using SQLAlchemy.
    """
...
async def verify_api_key(
    ...
    Args:
        ...
        api_key (str): The API key to verify, obtained from the request headers.
    Raises:
        HTTPException: If the API key is not valid or not found.
    """
...
# Uncomment the following lines to run the application directly with Uvicorn
