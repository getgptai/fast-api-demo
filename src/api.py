...
async def startup_event():
    """
    Event handler for the startup event that creates all database tables.
    """
...
async def secure_data():
    """
    Endpoint to access secure data, protected by API key verification.
...
async def get_api_keys(session: Annotated[Session, Depends(get_db)]):
    ...
    Returns:
    List[APIKey]: A list of APIKey instances.
    """
