...
async def verify_api_key(
    ...
    Raises:
        HTTPException: 403 error if the API key is not valid.
    """
...
# Uncomment the following lines to run the application using Uvicorn if this script is the main module.
